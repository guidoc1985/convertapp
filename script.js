    ...
    function calcularKilos(){
        ...
        function calcularLitros(){
            ...
            function calcularLitro() {
                ...
                const conversiones = {
                    litro: {
                        galon: cantidad => cantidad /1000,
                        qtr: cantidad => cantidad * 1000,
                        pt: cantidad => cantidad * 1e+6,
                        taza: cantidad => cantidad * 1e+9,                        
                        onza: cantidad => cantidad / 1016   ,
                        cucharada: cantidad => cantidad /907.2,
                        cucharadita: cantidad => cantidad / 6.35,
                        m3: cantidad => cantidad * 2.205,
                        ml: cantidad => cantidad * 35.274,
                        gal: cantidad => cantidad * 35.274,
                        ctimperial: cantidad => cantidad * 35.274,
                        ptImperial: cantidad => cantidad * 35.274,
                        tazaImperial: cantidad => cantidad * 35.274,
                        ozLiquidaImperial: cantidad => cantidad * 35.274,
                        cucharadaImperial: cantidad => cantidad * 35.274,
                        cucharaditaImperial: cantidad => cantidad * 35.274,
                        pie3: cantidad => cantidad * 35.274,
                        pulgada3: cantidad => cantidad * 35.274,
